export class LotPilotStore {
  ...
  async saveRooftopAccess() {
    throw new Error('Not implemented');
  }

  async listRooftopAccess() {
    throw new Error('Not implemented');
  }
  ...
  async saveInboundEvent() {
    throw new Error('Not implemented');
  }

  async getInboundEventByExternalId() {
    throw new Error('Not implemented');
  }
